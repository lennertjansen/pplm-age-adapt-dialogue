...
#SBATCH --job-name=irm ## job name for calling 'squeue -u lennertj'
#SBATCH -o /home/code/SLURM/output/IRM-B.%j_%a.out ## this is where the terminal output is printed to. %j is root job number, %a array number
...
python train_classifiers.py --data 'bnc_rb' --epochs 2
